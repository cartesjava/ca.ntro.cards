...
public class PersonnageTableau extends CartesJavaModel<PersonnageTableau> implements Value, Serializable {
	...
	private List<FilmObjet> films = new ArrayList<>();

	public List<FilmObjet> getFilms() {
		return films;
	}

	public void setFilms(List<FilmObjet> films) {
		this.films = films;
	}
	...
	@Override
	public void copyDataFrom(PersonnageTableau other) {
		this.nom = other.nom;
