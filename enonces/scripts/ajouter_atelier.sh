...
echo ""
echo "==========================================="
echo "== SVP fermer Eclipse avant de continuer =="
echo "==========================================="
echo ""
...
sh "$scripts_dir/clean_all_projects.sh"

#sh "$scripts_dir/build_all_projects.sh"

sh -c "./gradlew $gradle_args build eclipse"
