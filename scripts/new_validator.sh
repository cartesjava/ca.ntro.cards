...
echo "" >> settings.gradle
echo "include 'validator_${project_name}'" >> settings.gradle
echo "include 'validator_${project_name}_solution'" >> settings.gradle
echo "project(':validator_${project_name}_solution').projectDir = file('solutions/validator_${project_name}_solution')" >> settings.gradle
