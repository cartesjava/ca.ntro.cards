...
import ca.ntro.cards.shift2.frontend.views.controls.Shift2EfficiencyMainCanvas;
...
public class Shift2GraphsView extends EfficiencyGraphsView {

	@FXML
	private VBox cardsViewContainer;

	@FXML
	private Shift2EfficiencyMainCanvas viewerCanvas;
